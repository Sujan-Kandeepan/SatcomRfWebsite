...
namespace SatcomRfWebsite.Controllers
{
    public class CalDataController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,AssetNumber,DeviceType,Frequency,CalFactor,ReturnLoss,CalDate")] tblCalData tblCalData)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,AssetNumber,DeviceType,Frequency,CalFactor,ReturnLoss,CalDate")] tblCalData tblCalData)
        {
            if (ModelState.IsValid)
            {
