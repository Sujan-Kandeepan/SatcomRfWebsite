...
namespace SatcomRfWebsite.Controllers
{
    public class CalDataController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,AssetNumber,DeviceType,Frequency,CalFactor,ReturnLoss,AddedDate")] tblCalData tblCalData)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,AssetNumber,DeviceType,Frequency,CalFactor,ReturnLoss,AddedDate")] tblCalData tblCalData)
        {
            if (ModelState.IsValid)
            {
